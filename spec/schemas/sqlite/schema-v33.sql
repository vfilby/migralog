...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  qualities TEXT NOT NULL,       -- JSON array of PainQuality enum values
  symptoms TEXT NOT NULL,        -- JSON array of Symptom enum values
  triggers TEXT NOT NULL,        -- JSON array of Trigger enum values
...
-- One AFTER INSERT/UPDATE/DELETE trigger per synced table (11 tables × 3 = 33),
