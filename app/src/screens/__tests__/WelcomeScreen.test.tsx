...
describe('WelcomeScreen', () => {
  ...
  describe('Step Navigation', () => {
    it('should render step 1 (Welcome) by default', () => {
      const { getByTestId, getByText } = renderWithProviders(<WelcomeScreen />);
    ...
    it('should show Back button on step 2 and higher', () => {
      const { getByText, queryByText } = renderWithProviders(<WelcomeScreen />);
    ...
    it('should navigate back to step 1 when Back is pressed on step 2', () => {
      const { getByText, getByTestId } = renderWithProviders(<WelcomeScreen />);
  ...
  describe('Accessibility', () => {
    it('should have Continue button with testID', () => {
      const { getByTestId } = renderWithProviders(<WelcomeScreen />);
      
      expect(getByTestId('next-button')).toBeTruthy();
    });

    it('should have Back button with testID on step 2', () => {
      const { getByText, getByTestId } = renderWithProviders(<WelcomeScreen />);
