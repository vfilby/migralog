...
export const medicationDoseRepository = {
  ...
  /**
   * Get usage count for each medication (number of doses logged)
   * Used to sort medications by frequency of use
   * @returns Map of medication IDs to their usage counts
   */
